...
# direct methods
.method public constructor <init>(Landroid/content/Context;Le7/h;)V
    .locals 1
    ...
    iput-object v0, p0, Lg7/b;->c:Le7/h$b;

    iput-object p1, p0, Lg7/b;->b:Landroid/content/Context;

    iput-object p2, p0, Lg7/b;->a:Le7/h;

    invoke-virtual {p2, v0}, Le7/h;->c(Le7/h$b;)V

    return-void
.end method

.method static synthetic a(Lg7/b;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lg7/b;->b:Landroid/content/Context;
...
.method public c(Ljava/util/List;)Ljava/util/Locale;
    ...
    iget-object v1, p0, Lg7/b;->b:Landroid/content/Context;
    ...
    invoke-static {v1}, Lg/b;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
    ...
    :cond_3
    invoke-static {v0, p1}, Lg7/a;->a(Ljava/util/List;Ljava/util/Collection;)Ljava/util/Locale;
    ...
    invoke-static {v0}, Lg/b;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
...
.method public d(Landroid/content/res/Configuration;)V
    ...
    :cond_1
    iget-object p1, p0, Lg7/b;->a:Le7/h;

    invoke-virtual {p1, v0}, Le7/h;->b(Ljava/util/List;)V
