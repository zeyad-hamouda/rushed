...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lv6/d;->m(Landroid/content/Context;)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {v0, p1, p2}, Lv6/d;->f(Landroid/content/Context;[Ljava/lang/String;)V
...
.method public a(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->c()Lt6/a$b;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->f()Lio/flutter/plugin/platform/x;
    ...
    :cond_0
    new-instance v2, Lio/flutter/plugin/platform/x;

    invoke-direct {v2}, Lio/flutter/plugin/platform/x;-><init>()V
    ...
    invoke-static {}, Lt6/a$b;->a()Lt6/a$b;
    ...
    invoke-virtual {p0, v1, v5, v6, v7}, Lio/flutter/embedding/engine/d;->b(Landroid/content/Context;Lio/flutter/plugin/platform/x;ZZ)Lio/flutter/embedding/engine/a;

    move-result-object p1

    if-eqz v3, :cond_2

    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->o()Le7/j;

    move-result-object v0

    invoke-virtual {v0, v3}, Le7/j;->c(Ljava/lang/String;)V

    :cond_2
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->k()Lt6/a;

    move-result-object v0

    invoke-virtual {v0, v2, v4}, Lt6/a;->j(Lt6/a$b;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lio/flutter/embedding/engine/a;->A(Landroid/content/Context;Lt6/a$b;Ljava/lang/String;Ljava/util/List;Lio/flutter/plugin/platform/x;ZZ)Lio/flutter/embedding/engine/a;
...
.method b(Landroid/content/Context;Lio/flutter/plugin/platform/x;ZZ)Lio/flutter/embedding/engine/a;
    .locals 10
