...
.method private copyAccessibilityFields(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p1}, La0/d;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Z

    move-result v1

    invoke-static {p2, v1}, Lio/flutter/view/j;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    invoke-static {p1}, Lio/flutter/view/k;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)I

    move-result v1

    invoke-static {p2, v1}, Lio/flutter/view/l;->a(Landroid/view/accessibility/AccessibilityNodeInfo;I)V

    invoke-static {p1}, La0/b;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Z

    move-result v1

    invoke-static {p2, v1}, Lio/flutter/view/a;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    invoke-static {p1}, Lio/flutter/view/m;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/util/List;

    move-result-object v0

    invoke-static {p2, v0}, Lio/flutter/view/n;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/util/List;)V

    invoke-static {p1}, Lio/flutter/view/o;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/CharSequence;

    move-result-object v0

    invoke-static {p2, v0}, Lio/flutter/view/c;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V

    invoke-static {p1}, Lio/flutter/view/h;->a(Landroid/view/accessibility/AccessibilityNodeInfo;)Z

    move-result p1

    invoke-static {p2, p1}, Lio/flutter/view/i;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
