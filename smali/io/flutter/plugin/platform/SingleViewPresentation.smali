...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/y;
    ...
    invoke-direct {v0, v1}, Lio/flutter/plugin/platform/y;-><init>(Landroid/content/Context;)V

    invoke-static {p1, v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->d(Lio/flutter/plugin/platform/SingleViewPresentation$d;Lio/flutter/plugin/platform/y;)Lio/flutter/plugin/platform/y;

    :cond_0
    iget-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/SingleViewPresentation$d;

    invoke-static {p1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->e(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/i0;
    ...
    new-instance v1, Lio/flutter/plugin/platform/i0;

    invoke-static {v0}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/y;

    move-result-object v2

    invoke-direct {v1, p1, v2}, Lio/flutter/plugin/platform/i0;-><init>(Landroid/view/WindowManager;Lio/flutter/plugin/platform/y;)V

    invoke-static {v0, v1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->f(Lio/flutter/plugin/platform/SingleViewPresentation$d;Lio/flutter/plugin/platform/i0;)Lio/flutter/plugin/platform/i0;
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->e(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/i0;

    move-result-object v1

    iget-object v2, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->outerContext:Landroid/content/Context;

    invoke-direct {p1, v0, v1, v2}, Lio/flutter/plugin/platform/SingleViewPresentation$c;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/i0;Landroid/content/Context;)V
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/SingleViewPresentation$d;->c(Lio/flutter/plugin/platform/SingleViewPresentation$d;)Lio/flutter/plugin/platform/y;
