...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->windowLayoutInfo(Landroid/app/Activity;)Lm8/b;
.end annotation
...
# direct methods
.method constructor <init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lt7/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic a(Ll8/f;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invokeSuspend$lambda-0(Ll8/f;Landroidx/window/layout/WindowLayoutInfo;)V

    return-void
.end method

.method private static final invokeSuspend$lambda-0(Ll8/f;Landroidx/window/layout/WindowLayoutInfo;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Ll8/t;->b(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final create(Ljava/lang/Object;Lt7/d;)Lt7/d;
    ...
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lt7/d;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Lm8/c;Lt7/d;)Ljava/lang/Object;
...
.method public final invoke(Lm8/c;Lt7/d;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->create(Ljava/lang/Object;Lt7/d;)Lt7/d;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Ll8/e;->f:Ll8/e;

    const/4 v5, 0x4

    const/4 v6, 0x0

    invoke-static {v1, v4, v6, v5, v6}, Ll8/h;->b(ILl8/e;La8/l;ILjava/lang/Object;)Ll8/f;

    move-result-object v1

    new-instance v4, Landroidx/window/layout/f;

    invoke-direct {v4, v1}, Landroidx/window/layout/f;-><init>(Ll8/f;)V
    ...
    invoke-interface {v5, v6, v7, v4}, Landroidx/window/layout/WindowBackend;->registerLayoutChangeCallback(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lz/a;)V

    :try_start_2
    invoke-interface {v1}, Ll8/p;->iterator()Ll8/g;
    ...
    invoke-interface {v1, v5}, Ll8/g;->a(Lt7/d;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Ll8/g;->next()Ljava/lang/Object;
    ...
    invoke-interface {v6, p1, v5}, Lm8/c;->emit(Ljava/lang/Object;Lt7/d;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lz/a;)V
    ...
    invoke-interface {v0, v4}, Landroidx/window/layout/WindowBackend;->unregisterLayoutChangeCallback(Lz/a;)V
