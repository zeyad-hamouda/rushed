...
.method private final addListener(Ljava/util/concurrent/Executor;Lz/a;Lm8/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Lj8/n0;->a(Lt7/g;)Lj8/m0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lm8/b;Lz/a;Lt7/d;)V
...
.method private final removeListener(Lz/a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, v3, v2, v3}, Lj8/y1$a;->a(Lj8/y1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
...
# virtual methods
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lz/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p1}, Landroidx/window/layout/WindowInfoTracker;->windowLayoutInfo(Landroid/app/Activity;)Lm8/b;

    move-result-object p1

    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Lz/a;Lm8/b;)V

    return-void
.end method

.method public final removeWindowLayoutInfoListener(Lz/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->removeListener(Lz/a;)V

    return-void
.end method

.method public windowLayoutInfo(Landroid/app/Activity;)Lm8/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
