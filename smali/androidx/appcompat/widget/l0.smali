...
.field private final k:Landroidx/appcompat/widget/l0$c;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    invoke-direct {p1}, Landroidx/appcompat/widget/l0$b;-><init>()V

    :goto_0
    iput-object p1, p0, Landroidx/appcompat/widget/l0;->k:Landroidx/appcompat/widget/l0$c;
    ...
    new-instance p1, Landroidx/appcompat/widget/l0$a;

    invoke-direct {p1}, Landroidx/appcompat/widget/l0$a;-><init>()V
    ...
    invoke-direct {p1}, Landroidx/appcompat/widget/l0$c;-><init>()V
...
.method private e(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/l0;->h:Landroid/text/TextPaint;
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/l0;->i:Landroid/widget/TextView;
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/j0;->a(Landroid/widget/TextView;)I
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/k0;->a(Landroid/widget/TextView;)I
    ...
    :try_start_0
    iget-object p2, p0, Landroidx/appcompat/widget/l0;->k:Landroidx/appcompat/widget/l0$c;

    iget-object p3, p0, Landroidx/appcompat/widget/l0;->i:Landroid/widget/TextView;

    invoke-virtual {p2, p1, p3}, Landroidx/appcompat/widget/l0$c;->a(Landroid/text/StaticLayout$Builder;Landroid/widget/TextView;)V
    :try_end_0
...
.method private f(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/l0;->h:Landroid/text/TextPaint;
...
.method private g(Landroid/graphics/RectF;)I
    ...
    invoke-direct {p0, v3, p1}, Landroidx/appcompat/widget/l0;->z(ILandroid/graphics/RectF;)Z
...
.method static o(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/widget/l0;->m(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private u(F)V
    ...
    invoke-static {v1}, Landroidx/appcompat/widget/l0;->m(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private w()Z
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/l0;->A()Z
...
.method private z(ILandroid/graphics/RectF;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/l0;->n(I)V
    ...
    invoke-static {p1, v3, v2}, Landroidx/appcompat/widget/l0;->o(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
...
.method a()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/l0;->p()Z
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/l0;->k:Landroidx/appcompat/widget/l0$c;

    iget-object v1, p0, Landroidx/appcompat/widget/l0;->i:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/l0$c;->b(Landroid/widget/TextView;)Z
    ...
    invoke-direct {p0, v2}, Landroidx/appcompat/widget/l0;->g(Landroid/graphics/RectF;)I
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/appcompat/widget/l0;->v(IF)V
...
.method d(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/appcompat/widget/l0;->e(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/l0;->f(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
...
.method q(Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/l0;->x(Landroid/content/res/TypedArray;)V
    ...
    :cond_7
    invoke-direct {p0, p2, v2, p1}, Landroidx/appcompat/widget/l0;->B(FFF)V
...
.method r(IIII)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/l0;->B(FFF)V
...
.method t(I)V
    ...
    invoke-direct {p0, v0, p1, v1}, Landroidx/appcompat/widget/l0;->B(FFF)V
...
.method v(IF)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/l0;->u(F)V
