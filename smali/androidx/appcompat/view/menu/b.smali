...
.field private final p:Landroidx/appcompat/widget/a1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->p:Landroidx/appcompat/widget/a1;
...
.method private D()I
    ...
    invoke-static {v0}, Landroidx/core/view/n0;->q(Landroid/view/View;)I
...
.method private F(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/b;->z()Landroidx/appcompat/widget/e1;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/z0;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/z0;->B(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->r:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/z0;->C(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/e1;->Q(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/e1;->N(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/z0;->z(Landroid/view/View;)V
    ...
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/z0;->l(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/z0;->I(Z)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/z0;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/z0;->D(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Landroidx/appcompat/widget/e1;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->m:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/z0;->a()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/z0;->g()Landroid/widget/ListView;
...
.method private z()Landroidx/appcompat/widget/e1;
    .locals 5
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->p:Landroidx/appcompat/widget/a1;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/e1;->P(Landroidx/appcompat/widget/a1;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/z0;->z(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->r:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/z0;->C(I)V
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/e1;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/e1;->O(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/e1;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/z0;->A(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/e1;
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/e1;

    invoke-virtual {v3}, Landroidx/appcompat/widget/z0;->c()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/e1;
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/e1;

    invoke-virtual {v4}, Landroidx/appcompat/widget/z0;->c()Z
...
.method public p(Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroidx/core/view/n0;->q(Landroid/view/View;)I

    move-result p1

    invoke-static {v0, p1}, Landroidx/core/view/i;->a(II)I
